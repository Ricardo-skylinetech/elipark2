...
switch ($_SERVER['SERVER_NAME']) {
    ...
    case 'localhost': // LOCAL
        $config['base_url'] = 'http://localhost/elipark2/';
        break;
    
    case 'elipark.skylinetech.com.mx': //PRUEBAS
        $config['base_url'] = 'https://elipark.skylinetech.com.mx/';
        break;

    case 'webv2.elipark.com': //PRODUCTIVO
        $config['base_url'] = 'http://webv2.elipark.com/';
        break;

    case '192.168.50.2':
        $config['base_url'] = 'http://192.168.50.2/elipark2/';
        break;
