...
?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <h6 class="m-0 font-weight-bold text-primary">Detalle de pensiones del mes de: <b id='textMes2'><?= date('M'); ?></b></h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="date" class="form-control" id="n-fechaAlta" name="n-fechaAlta">
                                    </div>
                                </div>
                                <br>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                         <select id="n-tipoPension" name="n-tipoPension" class="form-control-sm" style="width: 100%">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                         ...
                                         <select id="e-tipoPension" name="e-tipoPension" class="form-control-sm" style="width: 100%" readonly>
                                            <option value="" selected disabled>Elige una opción</option>
                                            <option value="CORTESIA">CORTESIA</option>
                                            <option value="LOCATARIOS">LOCATARIOS</option>
                                            <option value="EXTERNA">EXTERNA</option>
