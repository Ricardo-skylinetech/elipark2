                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Cátalogo Boletos de Operación</h1>
                    <div class="row">
                        <div class="col-lg-9">
                            <!-- DataTales Example -->
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm" id="tbl_cBoperacion" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Concepto</th>
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        let tbl_cBoperacion = $('#tbl_cBoperacion').DataTable();
                        fn_tbl_cBoperacion(estatus=1);

                        function fn_tbl_cBoperacion(estatus) {
                            tbl_cBoperacion = $('#tbl_cBoperacion').DataTable({
                                destroy: true,
                                dom: 'Bfrtip',
                                buttons: [
                                    // {
                                    ...
                                    //         (estatus == 1 ? fn_tbl_cBoperacion(estatus=0) : fn_tbl_cBoperacion(estatus=1));
                                    //     }
                                    // },
                                    {
                        ...
                        $("#tbl_cBoperacion tbody").on("click", "a.estatus", function () {
                            let data = tbl_cBoperacion.row($(this).parents("tr")).data();
                            let id = data.id;
                            let estatus = $(this).data('estatus');
                            console.log(id);
                            $('.loading').fadeIn('slow');
                            $.post("../../updateEstatusCatBoperacion", {id:id,estatus:estatus},
                            function(result){
                                $('.loading').fadeOut('slow');
                        ...
                        $("#frm-alta").submit(function(event){
                            ...
                            $('.loading').fadeIn('slow');
                            $.post('../../insertConceptoBoperacion',data,
                            function(result){
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
                        ...
                        $("#tbl_cBoperacion tbody").on("click", "a.editConcepto", function () {
                            let data = tbl_cBoperacion.row($(this).parents("tr")).data();
                            $("#idC_e").val(data.id);
                        ...
                        $("#frm-editConcepto").submit(function(event) {
                            ...
                            $('.loading').fadeIn('slow');
                            $.post('../../updateConceptoBoperacion', data,
                            function(result) {
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
