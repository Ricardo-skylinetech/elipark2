                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Cátalogo Boletos Pensiones</h1>
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- DataTales Example -->
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Boletos Pensiones</h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm" id="tbl_cBoletosPensiones" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Concepto</th>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tarifas Boletos Pensiones</h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm tarifas" id="tbl_tBoletosPensiones" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Tarifa</th>
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        let tbl_cBoletosPensiones = $('#tbl_cBoletosPensiones').DataTable();
                        fn_tbl_cBoletosPensiones(estatus=1);

                        let tbl_tBoletosPensiones = $('#tbl_tBoletosPensiones').DataTable();
                        fn_tbl_tBoletosPensiones(estatus=1);

                        function fn_tbl_cBoletosPensiones(estatus) {
                            tbl_cBoletosPensiones = $('#tbl_cBoletosPensiones').DataTable({
                                destroy: true,
                                dom: 'Bfrtip',
                                buttons: [
                                    // {
                                    ...
                                    //         (estatus == 1 ? fn_tbl_cBoletosPensiones(estatus=0) : fn_tbl_cBoletosPensiones(estatus=1));
                                    //     }
                                    // },
                                    {
                        ...
                        $("#tbl_cBoletosPensiones tbody").on("click", "a.estatus", function () {
                            let data = tbl_cBoletosPensiones.row($(this).parents("tr")).data();
                            let id = data.id;
                            let estatus = $(this).data('estatus');
                            console.log(id);
                            $('.loading').fadeIn('slow');
                            $.post("../../updateEstatusCatBpensiones", {id:id,estatus:estatus},
                            function(result){
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
                                        ...
                                        tbl_cBoletosPensiones.ajax.reload();
                                    });
                                }else{
                                    Swal.fire({
                                        title:'Error',
                        ...
                        $("#frm-alta_concepto").submit(function(event){
                            ...
                            $('.loading').fadeIn('slow');
                            $.post('../../insertConceptoCatBpensiones',data,
                            function(result){
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
                        ...
                        $("#tbl_cBoletosPensiones tbody").on("click", "a.editConcepto", function () {
                            let data = tbl_cBoletosPensiones.row($(this).parents("tr")).data();
                            $("#idC_e").val(data.id);
                        ...
                        $("#frm-editConcepto").submit(function(event) {
                            ...
                            var data = $(this).serialize();
                            $('.loading').fadeIn('slow');
                            $.post('../../updateConceptoCatBpensiones', data,
                            function(result) {
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
                        ...
                        function fn_tbl_tBoletosPensiones(estatus) {
                            tbl_tBoletosPensiones = $('#tbl_tBoletosPensiones').DataTable({
                                destroy: true,
                                dom: 'Bfrtip',
                                buttons: [
                                    // {
                                    //     text: (estatus == 1 ? 'Eliminados' : 'Activos'),
                                    //     action: function ( e, dt, node, config ) {
                                    //         (estatus == 1 ? fn_tbl_tBoletosPensiones(estatus=0) : fn_tbl_tBoletosPensiones(estatus=1));
                                    //     }
                                    // },
                                    {
                                        text: '<i class="fas fa-plus"></i>',
                        ...
                        $("#tbl_tBoletosPensiones tbody").on("click", "a.estatus", function () {
                            let data = tbl_tBoletosPensiones.row($(this).parents("tr")).data();
                            let id = data.id;
                            let estatus = $(this).data('estatus');
                            console.log(id);
                            $('.loading').fadeIn('slow');
                            $.post("../../updateEstatusCatTpensiones", {id:id,estatus:estatus},
                            function(result){
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
                                        ...
                                        tbl_tBoletosPensiones.ajax.reload();
                                    });
                                }else{
                                    Swal.fire({
                                        title:'Error',
                        ...
                        $("#frm-alta_tarifa").submit(function(event){
                            ...
                            var data = $(this).serialize();
                            $('.loading').fadeIn('slow');
                            $.post('../../insertTarifaCatTpensiones',data,
                            function(result){
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
                        ...
                        $("#tbl_tBoletosPensiones tbody").on("click", "a.editTarifa", function () {
                            let data = tbl_tBoletosPensiones.row($(this).parents("tr")).data();
                            $("#idT_e").val(data.id);
                        ...
                        $("#frm-editTarifa").submit(function(event) {
                            ...
                            var data = $(this).serialize();
                            $('.loading').fadeIn('slow');
                            $.post('../../updateTarifaCatTpensiones', data,
                            function(result) {
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
