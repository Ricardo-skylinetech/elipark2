                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Cátalogo Boletos Recobros</h1>
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- DataTales Example -->
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Boletos Recobros</h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm" id="tbl_cBoletosRecobros" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Concepto</th>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Tarifas Boletos BoletosRecobros</h6>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm tarifas" id="tbl_tBoletosRecobros" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Concepto</th>
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        let tbl_cBoletosRecobros = $('#tbl_cBoletosRecobros').DataTable();
                        fn_tbl_cBoletosRecobros(estatus=1);

                        let tbl_tBoletosRecobros = $('#tbl_tBoletosRecobros').DataTable();
                        fn_tbl_tBoletosRecobros(estatus=1);

                        function fn_tbl_cBoletosRecobros(estatus){ 
                            tbl_cBoletosRecobros = $('#tbl_cBoletosRecobros').DataTable({
                                destroy: true,
                                dom: 'Bfrtip',
                                buttons: [
                                    // {
                                    ...
                                    //         (estatus == 1 ? fn_tbl_cBoletosRecobros(estatus=0) : fn_tbl_cBoletosRecobros(estatus=1));
                                    //     }
                                    // },
                                    {
                        ...
                        $("#tbl_cBoletosRecobros tbody").on("click", "a.estatus", function () {
                            let data = tbl_cBoletosRecobros.row($(this).parents("tr")).data();
                            let id = data.id;
                            ...
                            function(result){
                                ...
                                if(result.validacion){
                                    Swal.fire({
                                        ...
                                        tbl_cBoletosRecobros.ajax.reload();
                                    });
                                }else{
                                    Swal.fire({
                                        title:'Error',
                        ...
                        $("#tbl_cBoletosRecobros tbody").on("click", "a.editConcepto", function () {
                            let data = tbl_cBoletosRecobros.row($(this).parents("tr")).data();
                            $("#idC_e").val(data.id);
                        ...
                        function fn_tbl_tBoletosRecobros(estatus){
                            tbl_tBoletosRecobros = $('#tbl_tBoletosRecobros').DataTable({
                                destroy: true,
                                dom: 'Bfrtip',
                                buttons: [
                                    // {
                                    //     text: (estatus == 1 ? 'Eliminados' : 'Activos'),
                                    //     action: function ( e, dt, node, config ) {
                                    //         (estatus == 1 ? fn_tbl_tBoletosRecobros(estatus=0) : fn_tbl_tBoletosRecobros(estatus=1));
                                    //     }
                                    // },
                                    {
                                        text: '<i class="fas fa-plus"></i>',
                        ...
                        $("#tbl_tBoletosRecobros tbody").on("click", "a.estatus", function () {
                            let data = tbl_tBoletosRecobros.row($(this).parents("tr")).data();
                            let id = data.id;
                            let estatus = $(this).data('estatus');
                            console.log(id);
                            $('.loading').fadeIn('slow');
                            ...
                            function(result){
                                ...
                                if(result.validacion){
                                    Swal.fire({
                                        ...
                                        tbl_tBoletosRecobros.ajax.reload();
                                    });
                                }else{
                                    Swal.fire({
                                        title:'Error',
                        ...
                        $("#tbl_tBoletosRecobros tbody").on("click", "a.editTarifa", function () {
                            let data = tbl_tBoletosRecobros.row($(this).parents("tr")).data();
                            $("#idT_e").val(data.id);
