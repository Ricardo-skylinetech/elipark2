                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Cátalogo Informativo Prepagos</h1>
                    <div class="row">
                        <div class="col-lg-9">
                            <!-- DataTales Example -->
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-sm" id="tbl_cBinfoPrepago" width="100%" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>Id</th>
                                                    <th>Concepto</th>
                ...
                <script>
                    ...
                    $(document).ready(function() {
                        let tbl_cBinfoPrepago = $('#tbl_cBinfoPrepago').DataTable();
                        fn_tbl_cBinfoPrepago(estatus=1);

                        function fn_tbl_cBinfoPrepago(estatus) {
                            tbl_cBinfoPrepago = $('#tbl_cBinfoPrepago').DataTable({
                                destroy: true,
                                dom: 'Bfrtip',
                                buttons: [
                                    // {
                                    ...
                                    //         (estatus == 1 ? fn_tbl_cBinfoPrepago(estatus=0) : fn_tbl_cBinfoPrepago(estatus=1));
                                    //     }
                                    // },
                                    {
                        ...
                        $("#tbl_cBinfoPrepago tbody").on("click", "a.estatus", function () {
                            let data = tbl_cBinfoPrepago.row($(this).parents("tr")).data();
                            let id = data.id;
                            let estatus = $(this).data('estatus');
                            console.log(id);
                            $('.loading').fadeIn('slow');
                            $.post("../../updateEstatusCatBinfoPrepago", {id:id,estatus:estatus},
                            function(result){
                                $('.loading').fadeOut('slow');
                        ...
                        $("#frm-alta").submit(function(event){
                            ...
                            $('.loading').fadeIn('slow');
                            $.post('../../insertConceptoBinfoPrepago',data,
                            function(result){
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
                        ...
                        $("#tbl_cBinfoPrepago tbody").on("click", "a.editConcepto", function () {
                            let data = tbl_cBinfoPrepago.row($(this).parents("tr")).data();
                            $("#idC_e").val(data.id);
                        ...
                        $("#frm-editConcepto").submit(function(event) {
                            ...
                            $('.loading').fadeIn('slow');
                            $.post('../../updateConceptoBinfoPrepago', data,
                            function(result) {
                                $('.loading').fadeOut('slow');
                                if(result.validacion){
                                    Swal.fire({
