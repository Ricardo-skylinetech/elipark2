<div class="table-responsive" id="template3" style="display:none;"> <!-- ISLA2 -->
    <table data-template="todos" class="table table-bordered table-sm" id="tblTemplate3" width="100%" cellspacing="0">
        <thead>
            <tr>
                <th>partida_id</th>
                <th>Proyecto</th>
                <th>Fecha</th>
                <th>Dia</th>
                <th>Boletos generados fisicos</th>
